...
const MainLayout = ({ children }) => {
  return (
    ...
    <div className="min-h-[100dvh] w-full max-w-[100vw] flex flex-col relative overflow-x-hidden">
    ...
    <main className="flex-1 flex flex-col items-center w-full">
      {/* w-full: Ekranı tam kapla 
         px-4: Kenarlardan çok az (16px) boşluk bırak ki içerik ekrana yapışmasın
      */}
