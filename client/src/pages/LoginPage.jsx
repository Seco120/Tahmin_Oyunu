...
export default function LoginPage() {
  ...
  const handleGuestLogin = () => {
    ...
    setStatus({ 
      type: 'success', 
      message: "Misafir girişi yapıldı. Yönlendiriliyorsunuz..." 
    });
  ...
  return (
    /* fixed inset-0 kaldırıldı, min-h-screen ve overflow-y-auto eklendi */
    <div className="min-h-screen w-full font-['Montserrat'] flex flex-col items-center pt-32 md:pt-12 pb-10 px-4 bg-transparent overflow-x-hidden">
      
      {/* BAŞLIK - Mobilde text boyutu küçültüldü */}
      <div className="relative z-50 text-center mb-8 md:mb-12">
        ...
        <p className="text-[#ff7b00] text-[9px] md:text-sm mt-2 font-black uppercase tracking-[0.25em]">
          {isForgotMode 
            ...
            : "Sisteme giriş yaparak maceraya devam edin"}
        </p>
      </div>

      <div className="relative w-full max-w-[850px] z-40">
        {/* CHARACTER IMAGE - Mobilde gizlendi, sadece büyük ekranlarda var */}
        ...
        >
          {/* Form alanı mobilde full, masaüstünde yarı genişlik */}
          <div className="w-full lg:w-1/2">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="pt-2 space-y-4">
                ...
                >
                  {loading ? "BEKLEYİN..." : (isForgotMode ? "GÖNDER" : "GİRİŞ YAP")}
                </motion.button>
                ...
                {!isForgotMode && (
                  <>
                    ...
                    <motion.button 
                      ...
                      className="w-full h-15 bg-white/5 hover:bg-white/10 text-white border border-white/10 flex items-center justify-center gap-3 rounded-xl transition-all uppercase font-black text-[12px] tracking-tight"
                    >
