...
<div className="min-h-[100dvh] w-full font-['Montserrat'] flex flex-col items-center justify-start pt-12 md:pt-12 pb-10 px-4 bg-transparent overflow-y-auto overflow-x-hidden">      
